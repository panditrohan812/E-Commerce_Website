...
const BLOG_POSTS = [
  {
    ...
    title: "5 Wardrobe Staples for Every Season",
    excerpt:
      "A capsule wardrobe saves time and money. Here are the pieces worth investing in this year.",
  },
  {
    img: "https://images.unsplash.com/photo-1483985988355-763728e1935b?w=400&q=80",
    title: "How to Shop Smarter This Sale Season",
    excerpt:
      "Simple tips to make the most of end of season discounts without overspending.",
  },
  {
    img: "https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=400&q=80",
    title: "Beauty Essentials You Shouldn't Skip",
    excerpt:
      "Our editors round up the cosmetics staples worth keeping in every routine.",
  },
  {
    img: "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=400&q=80",
    title: "Meet the Team Behind Shopingo",
    excerpt:
      "A behind the scenes look at the people curating your favourite products.",
  },
];
...
function renderNewArrivals(products) {
  ...
  el.innerHTML = list
    .map((p) => `<div class="item">${renderProductCard(p)}</div>`)
    .join("");
  // Re-init owl
...
function renderMiniLists(products) {
  const byRatingCount = [...products].sort(
